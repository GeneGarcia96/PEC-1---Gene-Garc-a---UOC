...
# Confirmar que no haya valores NA/NaN/Inf
if (any(is.na(metabolites_data_clean) | is.nan(metabolites_data_clean) | is.infinite(metabolites_data_clean))) {
  stop("Todavía hay valores no numéricos en los datos después de la limpieza.")
}
...
# 2. Realizar el clustering jerárquico usando el método de enlace deseado (por ejemplo, "ward.D2")
...
### Diagrama dispercion de pares 

# Seleccionar algunos metabolitos para el análisis (primeros 4 en este ejemplo)
selected_metabolites <- metabolite_clean[, 1:4]

# Graficar el Diagrama de Dispersión de Pares
pairs(selected_metabolites,
      main = "Diagrama de Dispersión de Pares de Metabolitos Seleccionados",
      pch = 19, col = "blue")
